...
public class ProjectileRightTest {
    ProjectileRight projectile;
    @BeforeEach
    public void setup(){
        projectile = new ProjectileRight(new Image("/images/arrow/arrow_1.png"),new Position(10,10),5,10,10,10);
    }
    @Test
    ...
    public void updatePositionTest(){
        ...
        Assertions.assertEquals(new Position(15,10),projectile.getPosition());
        Assertions.assertEquals(new Position(20,10),projectile.getNextPosition().getPosition());
        Assertions.assertEquals(new Position(15,10),projectile.getPosition());
    }
    @Test
