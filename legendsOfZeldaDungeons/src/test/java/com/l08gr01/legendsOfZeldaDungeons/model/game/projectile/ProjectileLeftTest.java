...
public class ProjectileLeftTest {
    ProjectileUp projectile;
    @BeforeEach
    public void setup(){
        projectile = new ProjectileUp(new Image("/images/arrow/arrow_1.png"),new Position(10,10),5,10,10,10);
    }
    @Test
    ...
    public void updatePositionTest(){
        ...
        Assertions.assertEquals(new Position(10,5),projectile.getPosition());
        Assertions.assertEquals(new Position(10,0),projectile.getNextPosition().getPosition());
        Assertions.assertEquals(new Position(10,5),projectile.getPosition());
    }
    @Test
