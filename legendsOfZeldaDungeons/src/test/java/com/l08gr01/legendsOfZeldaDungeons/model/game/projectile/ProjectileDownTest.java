...
public class ProjectileDownTest {

    ProjectileDown projectile;
        @BeforeEach
        public void setup(){
            projectile = new ProjectileDown(new Image("/images/arrow/arrow_1.png"),new Position(10,10),5,10,10,10);
        }
        @Test
        ...
        public void updatePositionTest(){
            ...
            Assertions.assertEquals(new Position(10,15),projectile.getPosition());
            Assertions.assertEquals(new Position(10,20),projectile.getNextPosition().getPosition());
            Assertions.assertEquals(new Position(10,15),projectile.getPosition());
        }
        @Test
